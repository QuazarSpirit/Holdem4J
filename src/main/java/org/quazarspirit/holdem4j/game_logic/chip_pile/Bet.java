...
public class Bet extends ChipCount implements IBet {
    ...
    /**
     * <a href="https://www.pokerlistings.com/texas-holdem-betting-rules">Holdem betting rules</a>
    ...
    public static boolean isValid (Game game, int count, IPlayer player, Table table) {
        ...
        ChipCount minimumBet = new ChipCount(unit, 2);; // Expressed in Number of SB
